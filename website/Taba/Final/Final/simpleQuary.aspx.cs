...
namespace Final
{
	public partial class simpleQuary : System.Web.UI.Page
	{
        public string st = "";
        public string msg = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.Form["submit"] != null)
            {
                ...
                else
                {
                    ...
                    st += "<th style='text-align: center; border: 1px solid black;'>טלוויזיה</th>";
                    st += "<th style='text-align: center; border: 1px solid black;'>סוסים</th>";
