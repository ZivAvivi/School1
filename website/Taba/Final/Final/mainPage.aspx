...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <h2 id="about">עלינו</h2>
    ...
    <div style="text-align: center;">
        <img src="Pics/lion.jpg" alt="תמונה1" title="1תמונה" />
        <img src="Pics/lion2.jpg" alt="תמונה3" title="תמונה2" />
        <img src="Pics/lion3.png" alt="תמונה3" title="תמונה3" />
    </div>
    ...
    <p>פעילות מתנדבי 'לב אחד' בתוכנית ההתנתקות ובמלחמת לבנון השנייה חידדו את הצורך ביצירת תשתית קבועה של מתנדבים, שיפעלו באופן מסודר ומרוכז מתוך האוכלוסייה האזרחית עצמה. לצורך כך גובש מודל פעילות ייחודי, העונה על צרכים אלה:</p>
